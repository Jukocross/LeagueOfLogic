...
module variable_3bit_generator_20 (
    input clk,
    input rst,
    output reg out,
    output reg [2:0] threeBitValue
  );
  ...
  edge_detector_18 edge_detector_rng (
    .clk(clk),
  ...
  edge_detector_18 edge_detector_seed (
    .clk(clk),
  ...
  always @* begin
    ...
    threeBitValue = M_random_number_num[0+2-:3];
    if (M_edge_detector_seed_out) begin
      M_seed_d = M_seed_q + 1'h1;
    end
    
    case (temp_pointer[0+3-:4])
      1'h0: begin
        out = M_seed_q[0+0-:1];
      end
      1'h1: begin
